...
<body>
    <div class="container pt-5">
        <form action="/signup" method="POST" class="form d-flex flex-column p-3 border shadow rounded m-auto mt-5" style="width: 400px;">
            @csrf
            @if (session('success'))
            ...
            <button class="mt-2 rounded border-1 btn btn-primary" type="submit">Sign Up</button>
