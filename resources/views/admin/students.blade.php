...
<div>
    <div class="d-flex p-3 justify-content-between">
        ...
        <button type="button" class="btn btn-primary shadow" data-bs-toggle="modal" data-bs-target="#addStudent">
            Add Students
        </button>
    ...
    <div class="mb-2 d-flex justify-content-between">
        ...
        <form action="/selectedStudent" method="get">
    ...
    <table class="table w-100 shadow rounded">
        <thead class="w-100">
            <tr class="table-dark">
                ...
                <th class="border border-1 border-black text-center">Date of Admission</th>
                <th class="border border-1 border-black text-center">Class</th>
        ...
        <tbody class="w-100">
            ...
            <tr>
                <td class="border border-1 border-black bg-white ">{{ $student->name }}</td>
                <td class="border border-1 border-black bg-white ">{{ $student->email }}</td>
                <td class="border border-1 border-black bg-white text-center">{{ date('d - M - Y', strtotime($student->created_at)) }}</td>
                <td class="border border-1 border-black bg-white text-center">{{ $student->classroom->name ?? 'Not in CLass' }}</td>
                <td class="border border-1 border-black bg-white text-center">{{ $student->role }}</td>
                <td class="border border-1 border-black bg-white text-center">
                    ...
                    <!-- edit -->
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editStudent{{$student->id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-start">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="editStudent{{$student->id}}Label">Edit Student Profile</h1>
                                ...
                                <div class="modal-body">
                                    <form action="/edituser" method="POST" class="form d-flex flex-column p-3 ">
                                        ...
                                        <label class="form-label mt-3" for="Password{{$student->id}}">Old Password</label>
                                        <div class="d-flex border border-1 rounded align-items-center">
                                            <input class="form-control border-0 w-100 p-2" name="oldPassword" id="Password{{$student->id}}" type="password" placeholder="Old Password">
                                            <button type="button" id="eye{{$student->id}}" class="bg-transparent border-0 eye"><i class="fa-solid fa-eye mx-2"></i></button>
                                        </div>
                                        <label class="form-label mt-3" for="newPassword{{$student->id}}">New Password</label>
                                        <div class="d-flex border border-1 rounded align-items-center">
                                            <input class="form-control border-0 w-100 p-2" name="newPassword" id="newPassword{{$student->id}}" type="password" placeholder="New Password">
                                            <button type="button" id="eyeNew{{$student->id}}" class="bg-transparent border-0 eye"><i class="fa-solid fa-eye mx-2"></i></button>
                                        </div>
                                        <label class="form-label mt-3" for="ConfirmPassword{{$student->id}}">Confirm Password</label>
                                        <div class="d-flex border border-1 rounded align-items-center">
                                            <input class="form-control border-0 w-100 p-2" name="confirmPassword" id="confirmPassword{{$student->id}}" type="password" placeholder="Confirm Password">
                                            <button type="button" id="eyeConfirm{{$student->id}}" class="bg-transparent border-0 eye"><i class="fa-solid fa-eye mx-2"></i></button>
                                        </div>
